-- Fix search_users_by_username function to properly cast COALESCE defaults to numeric
-- The issue is COALESCE(numeric_column, integer) returns integer, not numeric
...
BEGIN
  ...
  SELECT
    ...
    COALESCE(us.credibility, 50::numeric) as credibility,  -- Cast 50 to numeric
    COALESCE(us.mojo, 0::numeric) as mojo,                 -- Cast 0 to numeric
    ug.activity as goal_type,
    ug.sub_activity,
