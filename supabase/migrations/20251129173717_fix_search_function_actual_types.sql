-- Fix search_users_by_username function to use actual database types
-- credibility is integer (not numeric)
-- mojo is double precision but we'll cast it to numeric for consistency
