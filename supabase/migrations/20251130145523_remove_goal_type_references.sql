-- Remove goal_type references from search_users_by_username function
-- goal_type was removed from user_goals table in favor of activity and sub_activity
-- This migration updates the function to return 'activity' instead of 'goal_type'
...
BEGIN
  ...
  SELECT
    ...
    COALESCE(us.mojo, 0)::numeric as mojo,
    ug.activity,
    ug.sub_activity,
